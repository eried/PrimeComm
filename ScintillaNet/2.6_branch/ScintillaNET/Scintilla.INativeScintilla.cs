...
namespace ScintillaNet
{
	public partial class Scintilla	
	{
		...
		void INativeScintilla.AutoCSetCancelAtShowPoint(bool cancel)
		{
			_ns.SendMessageDirect(Constants.SCI_AUTOCSETCANCELATSTART, cancel, 0);
		}

		bool INativeScintilla.AutoCGetCancelAtShowPoint()
		{
        ...
        void INativeScintilla.AutoCSetCurList(string list)
        {
            _ns.SendMessageDirect(Constants.SCI_AUTOCSETCURLIST, VOID.NULL, list);
        }
