...
namespace Keyboard
{
	...
	public class Messaging
	{
		...
		public static void BackgroundMouseClick(IntPtr hWnd, Key key, int x, int y, int delay = 10)
		{
			switch (key.Vk)
			{
		...
		public static bool ForegroundKeyPress(Key key, int delay = 10)
		{
			bool temp = true;
		...
		public static bool ForegroundKeyPress(IntPtr hWnd, Key key, int delay = 10)
		{
			bool temp = true;
		...
		public static bool ForegroundKeyPressAll(IntPtr hWnd, Key key, bool alt, bool ctrl, bool shift, int delay = 10)
		{
			if (GetForegroundWindow() != hWnd)
			{
				if (!SetForegroundWindow(hWnd))
		...
		public static bool PostMessage(IntPtr hWnd, Key key, int delay = 10)
		{
			//Send KEY_DOWN
		...
		public static bool PostMessageAll(IntPtr hWnd, Key key, bool alt, bool ctrl, bool shift, int delay = 10)
		{
			CheckKeyShiftState();
			uint intReturn;
			INPUT structInput;
		...
		public static bool SendMessageDown(IntPtr hWnd, Key key, bool checkKeyboardState, int delay = 10)
		{
		...
		public static bool SendMessageUp(IntPtr hWnd, Key key, bool checkKeyboardState, int delay = 10)
		{
			if (checkKeyboardState)
				CheckKeyShiftState();
		...
		public static bool SendMessage(IntPtr hWnd, Key key, bool checkKeyboardState, int delay = 10)
		{
			if (checkKeyboardState)
				CheckKeyShiftState();
		...
		public static bool SendMessageAll(IntPtr hWnd, Key key, bool alt, bool ctrl, bool shift, int delay = 10)
		{
			CheckKeyShiftState();
			uint intReturn;
