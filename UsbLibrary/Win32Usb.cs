...
namespace UsbLibrary
{
    ...
    public class Win32Usb
    {
        ...
        protected static extern IntPtr RegisterDeviceNotification(IntPtr hwnd, DeviceBroadcastInterface oInterface,
            uint nFlags);
        ...
        protected static extern IntPtr CreateFile([MarshalAs(UnmanagedType.LPStr)] string strName, uint nAccess,
